...
namespace potato::analysis {
    enum class arg_effect { none, alloc, realloc_ptr, realloc_res, src, deref_src, copy_trg, assign_trg, unknown };
    enum class ret_effect { none, alloc, realloc_res, copy_trg, assign_trg, unknown};
