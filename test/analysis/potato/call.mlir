...
// CHECK-DAG: <block argument> of type '!llvm.ptr' at index: 0 -> {mem_alloc at: loc({{.*}}), mem_alloc at: loc({{.*}})}
// CHECK-DAG: <block argument> of type '!llvm.ptr' at index: 1 -> {mem_alloc at: loc({{.*}}), mem_alloc at: loc({{.*}})}
